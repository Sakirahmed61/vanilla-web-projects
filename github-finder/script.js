...
function displayUserData(user) {
  ...
  if (user.blog) {
    ...
    blogElement.href = "#";
    blogElement.removeAttribute("target")
  }
  ...
  if (user.twitter_username) {
    ...
    // twitterContainer.removeChild("a")
    // const altTwitterText = document.createElement("p")
    // twitterContainer.appendChild(altTwitterText)
    // altTwitterText.textContent = "No twitter available";
    twitterElement.textContent = "No Twitter";
    twitterElement.href = "#";
    twitterElement.removeAttribute("target")
  }
